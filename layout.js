...
var encounterDefine = `Time: ${blueText("{duration}")} &nbsp; Party DPS: ${blueText("{ENCDPS}")}`
if (FLAG_SHOW_MAX_HITS) {
  encounterDefine += `
    <br>${PARTY_MAX_HIT_TITLE}: ${blueText("{maxHitCustom}")}
    <br>${PLAYER_MAX_HIT_TITLE}: ${blueText("{myMaxHitCustom}")}
  `
}
